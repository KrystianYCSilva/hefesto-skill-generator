...
- Domain: requirement elicitation, specification quality, validation, and traceability.
- Common divergence areas: functional requirements, non-functional requirements, acceptance criteria, traceability.
