...
`java
record OrderCreated(String eventId, String orderId, Instant occurredAt, int schemaVersion) {}
`

## Kotlin Example

`kotlin
data class OrderCreated(val eventId: String, val orderId: String, val occurredAt: Instant, val schemaVersion: Int)
`
