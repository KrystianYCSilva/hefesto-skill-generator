...
description: |
  Guides event-driven architecture with Java and Kotlin using outbox, idempotent consumers, schema evolution, and consistency patterns.
  Use when: building asynchronous microservices with domain events and needing reliable delivery, replay, and compatibility governance.
---

# Event Driven Architecture Java Kotlin


The main operating scope is: Event contracts, outbox/inbox, retries, dead-letter handling, and sagas. Prioritize stable contracts, operational clarity, and compatibility-first delivery.

## How to design architecture and boundaries

- Use explicit contracts for Event contracts, outbox/inbox, retries, dead-letter handling, and sagas.
...
- Insufficient contract testing for changes touching Event contracts, outbox/inbox, retries, dead-letter handling, and sagas.
...
- [Official Documentation](https://microservices.io/patterns/data/transactional-outbox.html)
- [Official Documentation](https://www.enterpriseintegrationpatterns.com/)
- [Official Documentation](https://martinfowler.com/articles/201701-event-driven.html)
