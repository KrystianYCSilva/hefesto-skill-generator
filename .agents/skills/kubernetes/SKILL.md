...
description: |
  ...
  Use when: running containerized services at scale with declarative deployment, autoscaling, and resilience controls.
---

# Kubernetes

This skill supports professional execution in: workload manifests, networking, autoscaling, and operational governance.
...
- [Official Documentation](https://kubernetes.io/docs/concepts/)
- [Official Documentation](https://kubernetes.io/docs/tasks/)
