...
description: |
  Guides software construction practices for code organization, build reliability, maintainability, and technical execution quality.
  Use when: improving coding standards, build discipline, and implementation consistency in software teams.
---

# Software Construction

This skill supports professional execution in: implementation practices, build discipline, and maintainable construction workflows.
...
- [Official Documentation](https://www.computer.org/education/bodies-of-knowledge/software-engineering)
- [Official Documentation](https://martinfowler.com/bliki/ContinuousIntegration.html)
- [Official Documentation](https://12factor.net/)
