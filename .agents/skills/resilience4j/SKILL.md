...
name: resilience4j
description: |
  Guides resilience patterns with Resilience4j including circuit breaker, retry, bulkhead, and rate limiter design.
  Use when: hardening Java and Kotlin microservices against dependency instability and cascading failures.
---

# Resilience4j

This skill supports professional execution in: fault-tolerance policies, timeout budgets, and safe degradation patterns.
...
- [Official Documentation](https://resilience4j.readme.io/docs/getting-started-3)
- [Official Documentation](https://docs.spring.io/spring-cloud-circuitbreaker/reference/)
