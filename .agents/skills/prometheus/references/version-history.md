...
- Domain: metric naming, label cardinality, scraping, recording rules, and alert design.
- Common divergence areas: PromQL, metric labels, scrape configs, recording rules.
