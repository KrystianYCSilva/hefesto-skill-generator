...
name: prometheus
description: |
  Guides Prometheus metric modeling, scrape architecture, alert strategy, and JVM observability integration.
  Use when: building metrics-driven monitoring for Java and Kotlin services and creating actionable alerting signals.
---

# Prometheus

This skill supports professional execution in: metric naming, label cardinality, scraping, recording rules, and alert design.
...
- [Official Documentation](https://prometheus.io/docs/practices/naming/)
