...
description: |
  Guides secret lifecycle management with Secret Manager, IAM boundaries, rotation workflows, and secure runtime consumption in Java and Kotlin.
  Use when: managing credentials, API keys, certificates, and rotating sensitive configuration across GCP services.
---

# GCP Secret Manager


The main operating scope is: Secret versioning, IAM least privilege, rotation windows, and auditability. Prioritize stable contracts, operational clarity, and compatibility-first delivery.

## How to design architecture and boundaries

- Use explicit contracts for Secret versioning, IAM least privilege, rotation windows, and auditability.
...
- Insufficient contract testing for changes touching Secret versioning, IAM least privilege, rotation windows, and auditability.
...
- [Official Documentation](https://cloud.google.com/secret-manager/docs/best-practices)
- [Official Documentation](https://cloud.google.com/iam/docs/roles-permissions/secretmanager)
