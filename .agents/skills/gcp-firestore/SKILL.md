...
name: gcp-firestore
description: |
  Guides Firestore document modeling, index strategy, transactional patterns, and JVM integration for scalable backend systems.
  Use when: building document-oriented services, read projections, and low-latency event-driven views on GCP.
---

# GCP Firestore


The main operating scope is: Collection design, composite indexes, transactions, and consistency windows. Prioritize stable contracts, operational clarity, and compatibility-first delivery.

## How to design architecture and boundaries

- Use explicit contracts for Collection design, composite indexes, transactions, and consistency windows.
...
- Insufficient contract testing for changes touching Collection design, composite indexes, transactions, and consistency windows.
...
- [Official Documentation](https://cloud.google.com/firestore/docs/query-data/index-overview)
- [Official Documentation](https://cloud.google.com/firestore/docs/samples)
