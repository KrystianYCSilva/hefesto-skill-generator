...
description: |
  Guides database migration strategy with versioned scripts, backward compatibility, rollout safety, and rollback planning.
  Use when: evolving database schemas in production systems without downtime or data integrity regressions.
---

# Database Migrations

This skill supports professional execution in: schema migration lifecycle, rollout sequencing, and data safety controls.
...
- [Official Documentation](https://www.liquibase.com/documentation)
