...
description: |
  Guides planning systems that combine layered, hexagonal, microservices, and event-driven patterns with explicit boundary and rollout strategy.
  Use when: designing projects that intentionally mix more than one architecture pattern and need a coherent evolution roadmap.
---

# Multi Architecture Project Planning


The main operating scope is: Pattern composition, boundary governance, phased migration, and architecture decision management. Prioritize stable contracts, operational clarity, and compatibility-first delivery.

## How to design architecture and boundaries

- Use explicit contracts for Pattern composition, boundary governance, phased migration, and architecture decision management.
...
- Insufficient contract testing for changes touching Pattern composition, boundary governance, phased migration, and architecture decision management.
...
- [Official Documentation](https://martinfowler.com/articles/architectural-fitness-function.html)
- [Official Documentation](https://microservices.io/patterns/)
- [Official Documentation](https://martinfowler.com/articles/evodb.html)
