...
- Define architecture fitness checks for key constraints in this domain: Pattern composition, boundary governance, phased migration, and architecture decision management.
