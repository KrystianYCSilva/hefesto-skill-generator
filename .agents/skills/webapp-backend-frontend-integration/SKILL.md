...
description: |
  Guides backend-frontend integration with stable contracts, BFF patterns, session and CORS policy, and coordinated release governance.
  Use when: developing web applications where backend and frontend evolve together and require strict API compatibility and release choreography.
---

# WebApp Backend Frontend Integration


The main operating scope is: BFF design, OpenAPI contracts, browser security, and rollout governance. Prioritize stable contracts, operational clarity, and compatibility-first delivery.

## How to design architecture and boundaries

- Use explicit contracts for BFF design, OpenAPI contracts, browser security, and rollout governance.
...
- Insufficient contract testing for changes touching BFF design, OpenAPI contracts, browser security, and rollout governance.
...
- [Official Documentation](https://openapi.tools/)
- [Official Documentation](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS)
- [Official Documentation](https://martinfowler.com/articles/micro-frontends.html)
