...
name: gcp-trace
description: |
  Guides distributed tracing on GCP with Cloud Trace, context propagation, latency analysis, and JVM instrumentation.
  Use when: diagnosing latency and dependency issues across distributed Java and Kotlin systems on GCP.
---
