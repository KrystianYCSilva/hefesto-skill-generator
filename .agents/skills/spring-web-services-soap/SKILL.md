...
description: |
  Guides contract-first SOAP development with Spring Web Services, schema governance, endpoint security, and interoperability testing.
  Use when: implementing or modernizing enterprise SOAP services in Spring with strict WSDL and XSD compatibility.
---

# Spring Web Services SOAP


The main operating scope is: Spring-WS endpoints, WSDL/XSD governance, WS-Security, and compatibility strategy. Prioritize stable contracts, operational clarity, and compatibility-first delivery.

## How to design architecture and boundaries

- Use explicit contracts for Spring-WS endpoints, WSDL/XSD governance, WS-Security, and compatibility strategy.
...
- Insufficient contract testing for changes touching Spring-WS endpoints, WSDL/XSD governance, WS-Security, and compatibility strategy.
...
- [Official Documentation](https://spring.io/projects/spring-ws)
- [Official Documentation](https://docs.spring.io/spring-ws/docs/current/reference/)
- [Official Documentation](https://www.w3.org/TR/wsdl20/)
