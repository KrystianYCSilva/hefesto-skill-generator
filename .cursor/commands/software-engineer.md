...
- Read '.cursor/skills/software-architect/SKILL.md' for architecture patterns and trade-off analysis
- Read '.cursor/skills/code-reviewer/SKILL.md' for code quality and anti-pattern detection
- Read '.cursor/skills/design-patterns/SKILL.md' for Gang of Four patterns and implementations
- Read '.cursor/skills/legacy-code-refactoring/SKILL.md' for safe refactoring strategies
- Read '.cursor/skills/testing-expert/SKILL.md' for test strategy and quality assurance
