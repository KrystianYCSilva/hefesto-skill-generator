...
description: |
  Guides QA practices for process quality, release readiness, risk-based validation, and defect prevention in software delivery.
  Use when: setting QA governance, release criteria, and cross-team validation workflows.
---

# Quality Assurance

This skill supports professional execution in: QA process design, risk-based testing, and release confidence management.
...
- [Official Documentation](https://www.istqb.org/)
- [Official Documentation](https://www.iso.org/iso-9001-quality-management.html)
- [Official Documentation](https://sre.google/workbook/table-of-contents/)
