...
- Domain: dataset design, partitioning and clustering, query optimization, and governance.
- Common divergence areas: partitioned tables, clustering, slot usage, cost controls.
