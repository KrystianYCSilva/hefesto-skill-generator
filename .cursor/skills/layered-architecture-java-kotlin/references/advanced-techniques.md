...
- Define architecture fitness checks for key constraints in this domain: Layer responsibilities, dependency direction, module boundaries, and architecture fitness checks.
