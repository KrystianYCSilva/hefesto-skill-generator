...
- Read '.qwen/skills/software-architect/SKILL.md' for architecture patterns and trade-off analysis
- Read '.qwen/skills/code-reviewer/SKILL.md' for code quality and anti-pattern detection
- Read '.qwen/skills/design-patterns/SKILL.md' for Gang of Four patterns and implementations
- Read '.qwen/skills/legacy-code-refactoring/SKILL.md' for safe refactoring strategies
- Read '.qwen/skills/testing-expert/SKILL.md' for test strategy and quality assurance
