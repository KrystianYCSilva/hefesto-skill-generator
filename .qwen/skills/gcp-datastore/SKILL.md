...
name: gcp-datastore
description: |
  Guides Firestore in Datastore mode for schema modeling, query patterns, consistency, and backend integration.
  Use when: building key-value and entity workloads on GCP where Datastore mode fits access patterns and operational constraints.
---

# GCP Datastore

This skill supports professional execution in: entity modeling, index planning, and consistency in Datastore mode.
...
- [Official Documentation](https://cloud.google.com/datastore/docs/concepts/queries)
