...
description: |
  Guides Cloud Logging, Monitoring, Trace, and SLO-driven alerting for Java and Kotlin distributed systems on GCP.
  Use when: defining production observability baselines, reducing MTTR, and hardening incident response for cloud services.
---

# GCP Observability


The main operating scope is: Metrics, logs, traces, SLO burn-rate alerts, and incident diagnostics. Prioritize stable contracts, operational clarity, and compatibility-first delivery.

## How to design architecture and boundaries

- Use explicit contracts for Metrics, logs, traces, SLO burn-rate alerts, and incident diagnostics.
...
- Insufficient contract testing for changes touching Metrics, logs, traces, SLO burn-rate alerts, and incident diagnostics.
