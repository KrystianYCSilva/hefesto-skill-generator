...
description: |
  Guides requirements engineering from elicitation to specification, validation, and traceability for software projects.
  Use when: defining clear, testable requirements and controlling scope change across engineering delivery.
---

# Requirements Engineering

This skill supports professional execution in: requirement elicitation, specification quality, validation, and traceability.
...
- [Official Documentation](https://www.iiba.org/standards-and-resources/babok/)
- [Official Documentation](https://www.ireb.org/en/)
- [Official Documentation](https://www.volere.org/)
