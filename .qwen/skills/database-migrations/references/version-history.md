...
- Domain: schema migration lifecycle, rollout sequencing, and data safety controls.
- Common divergence areas: Flyway, Liquibase, expand-contract, backward compatibility.
