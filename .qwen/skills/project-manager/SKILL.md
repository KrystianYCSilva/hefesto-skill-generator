...
description: |
  Guides project management fundamentals for software initiatives including scope control, delivery planning, and communication governance.
  Use when: coordinating execution across product, engineering, QA, and platform stakeholders.
---

# Project Manager

This skill supports professional execution in: project lifecycle control, stakeholder communication, and delivery assurance.
...
- [Official Documentation](https://www.prince2.com/)
