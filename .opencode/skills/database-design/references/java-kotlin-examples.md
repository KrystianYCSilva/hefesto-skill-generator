...
`java
Model aggregate boundaries before table decomposition to avoid accidental coupling.
`

## Kotlin Example

`kotlin
Keep schema migrations aligned with domain versioning and API compatibility.
`
