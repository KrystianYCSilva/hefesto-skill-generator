...
- Read '.claude/skills/software-architect/SKILL.md' for architecture patterns and trade-off analysis
- Read '.claude/skills/code-reviewer/SKILL.md' for code quality and anti-pattern detection
- Read '.claude/skills/design-patterns/SKILL.md' for Gang of Four patterns and implementations
- Read '.claude/skills/legacy-code-refactoring/SKILL.md' for safe refactoring strategies
- Read '.claude/skills/testing-expert/SKILL.md' for test strategy and quality assurance
