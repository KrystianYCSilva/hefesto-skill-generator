...
description: |
  Guides software project management for planning, risk control, execution tracking, and stakeholder alignment.
  Use when: leading engineering delivery with multiple teams, dependencies, and architectural workstreams.
---

# Software Project Manager

This skill supports professional execution in: planning, risk management, execution control, and communication cadence.
...
- [Official Documentation](https://www.pmi.org/pmbok-guide-standards)
- [Official Documentation](https://www.atlassian.com/agile/project-management)
- [Official Documentation](https://www.scrum.org/resources/what-is-scrum)
