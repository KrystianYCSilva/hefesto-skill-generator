...
name: logger
description: |
  Guides logging architecture for Java and Kotlin services with structured logs, correlation IDs, and production-safe verbosity.
  Use when: designing or refactoring logging strategy for microservices, webapps, and asynchronous pipelines.
---

# Logger

This skill supports professional execution in: structured logging, log levels, trace correlation, and operational diagnostics.
...
- [Official Documentation](https://www.slf4j.org/manual.html)
- [Official Documentation](https://logback.qos.ch/documentation.html)
- [Official Documentation](https://docs.spring.io/spring-boot/reference/features/logging.html)
