...
description: |
  Guides Google Cloud Functions architecture, trigger selection, secure runtime integration, and operational tuning for Java and Kotlin workloads.
  Use when: building event-driven serverless handlers, lightweight HTTP endpoints, or moving JVM integrations to function-based execution on GCP.
---
