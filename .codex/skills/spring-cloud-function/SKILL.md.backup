...
description: |
  Guides Spring Cloud Function for transport-agnostic business logic, function composition, and serverless deployment patterns.
  Use when: building reusable Java or Kotlin functions deployable to HTTP, messaging, Cloud Run, and Cloud Functions runtimes.
---

# Spring Cloud Function


The main operating scope is: Function composition, adapter boundaries, and JVM serverless optimization. Prioritize stable contracts, operational clarity, and compatibility-first delivery.

## How to design architecture and boundaries

- Use explicit contracts for Function composition, adapter boundaries, and JVM serverless optimization.
...
- Insufficient contract testing for changes touching Function composition, adapter boundaries, and JVM serverless optimization.
...
- [Official Documentation](https://spring.io/projects/spring-cloud-function)
- [Official Documentation](https://docs.spring.io/spring-cloud-function/reference/)
- [Official Documentation](https://spring.io/blog/2018/10/22/serverless-java-with-spring-cloud-function)
