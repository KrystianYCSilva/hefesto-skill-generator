...
- Read '.github/skills/software-architect/SKILL.md' for architecture patterns and trade-off analysis
- Read '.github/skills/code-reviewer/SKILL.md' for code quality and anti-pattern detection
- Read '.github/skills/design-patterns/SKILL.md' for Gang of Four patterns and implementations
- Read '.github/skills/legacy-code-refactoring/SKILL.md' for safe refactoring strategies
- Read '.github/skills/testing-expert/SKILL.md' for test strategy and quality assurance
